...
@app.post("/chat")
async def post(prompt: UserInput) -> Output:
    prmpt = prompt.prompt
    ...
    return Output(process=agent_process, final_response=fin_report)
...
io = gr.ChatInterface(fn=reply, title="conversational.ai☕", theme=gr.Theme(primary_hue="rose",secondary_hue="emerald", font=["Arial", "sans-serif"]), examples=["Can you give me some information about Barack Obama?", "What are the latest news about AI?", "What is the weather now in San Francisco?"])
